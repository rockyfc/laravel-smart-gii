    ...
    <div  class="tab-content">
        <div class="tab-pane fade in active" style="padding:10px;" id="home">
            ...
            <div class="list-group">
                ...
                <a href="{{route('gii.model.fixer.show',['menu=model2'])}}" class="list-group-item @if(request('menu')=='model2') active @endif ">修复Eloquent Model Comment</a>
                <a href="{{route('gii.repository.index',['menu=repository'])}}" class="list-group-item @if(request('menu')=='repository') active @endif">创建Biz</a>
